...
export async function GET() {
    try {
        ...
        // --- Function to check if a combination passes the "Symmetrical Interval" criteria ---
        function checkCombination(combination) {
            const [n1, n2, n3] = combination;

            // Calculate the absolute numeric gap between the first and second digits.
            const gap1 = Math.abs(n2 - n1);

            // Calculate the absolute numeric gap between the second and third digits.
            const gap2 = Math.abs(n3 - n2);

            // If the gaps are equal, the combination is symmetrical and fails the filter.
            // We want to KEEP the combinations where the gaps are NOT equal.
            // Therefore, the combination passes if gap1 is not equal to gap2.
            return gap1 !== gap2;
        }
        ...
        const result = {
            ...
            strategyName: "Symmetrical Interval", // Updated strategy name
